<x-app-layout>
    ...
    <div class="py-12">
        <div class="max-w-7xl mx-auto sm:px-6 lg:px-8">
            <form action="{{ route('qualification.create') }}" method="post" class="flex items-center mb-3">
                @csrf
                <div class="w-full">
                    <x-text-input id="name" class="block mt-1 w-full" type="text" name="name" :value="old('name')" required placeholder="Qualification" />
            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <div class="p-6 text-gray-900">
                    ...
                    @else
                        <p class="text-center">No qualifications exist in the database!</p>
                    @endif
                </div>
            </div>
        </div>
